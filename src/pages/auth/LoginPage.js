    ...
    <div className="min-h-screen bg-background dark:bg-slate-900 flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-[480px] flex-shrink-0 bg-primary p-10">
        ...
        <div>
          ...
          >
            ...
            <p className="text-white/70 text-sm leading-relaxed">
              Structured paths, real project reviews, and a community that holds
              you accountable.
            </p>
          </motion.div>
          ...
          <div className="flex gap-6 mt-10">
            {[
              { val: "1,200+", label: "Learners" },
              { val: "8", label: "Active Paths" },
              { val: "4,800+", label: "Reviews Done" },
            ].map((s) => (
              <div key={s.label}>
        ...
        <p className="text-white/40 text-xs">
          © 2026 Sheghelak. All rights reserved.
        </p>
      </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <div className="flex items-center justify-between px-6 py-4">
          ...
          <div className="lg:ml-auto flex items-center gap-3">
            <button
              onClick={toggle}
              className="w-9 h-9 rounded flex items-center justify-center text-on-surface-variant dark:text-slate-400 hover:bg-surface-container dark:hover:bg-white/5"
            >
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {error && (
                <motion.p
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
                  className="text-sm text-error bg-error-container dark:bg-error/10 rounded px-3 py-2"
                >
                  {error}
                </motion.p>
              )}
